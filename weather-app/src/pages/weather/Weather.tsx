        ...
        {weather && (
            <>
             ...
             {weatherOne.weather.map((element:any) => {
                ...
                return <div key={element.dt} className="flex justify-center items-center">
                    <div style={{backgroundImage:`url(${backgroundImagePic})`, backgroundSize: 'cover', borderRadius: '0.5rem'}} className="text-gray-300 bg-gray-900 m-5 w-full rounded-lg md:bg-bottom md:bg-center" >
                    <div className="bg-gray-800/50 rounded-lg">   
                        <p className="bg-gray-800/50 flex p-2 rounded-lg"> {weather.city.name}, {weather.city.country} -- {date.toLocaleDateString()} </p>
                        <p className="text-4xl p-5 font-bold"> {weatherOne.main.temp} {toggleMetric()}           </p>
                    ...
                    <div className="flex justify-center text-gray-300 bg-gray-900 m-5 rounded-lg flex-col p-5">
                        ...
                        <p>feels Like:</p>
                        <p className="text-3xl font-bold flex">{weatherOne.main.feels_like}{toggleMetric()}</p>
                        </div>
                        <div className="flex flex-row justify-between pt-5">
                        <div className="">
                        <p className=""> Wind: {weatherOne.wind.speed}m/s</p>
                        <p className=" "> Humidity: {weatherOne.main.humidity}%  </p>
                        </div>
                        <div className="">  
                    ...
                    <div className="flex justify-center" key={element.dt}>
                        <div className="flex justify-evenly">
                            <div className="bg-gray-900 text-gray-300 m-0.5 rounded-lg">
                                ...
                                <div className="p-5">
                                    <p className="text-center"> Date: {dateHours}:{dateMinutes}                   </p>
                                    <p className="text-center"> Temp: {element.main.temp} {toggleMetric()}          </p>
        ...
        {weather &&  (
            <>
                ...
                {weather.list.map((element:any) => {
                    ...
                    return <div key={element.dt} className="flex justify-center ">
                    ...
                    <p className="">Date: {dateSpecific} </p>
                        ...
                        <p className=" pr-5"> Time: {dateHours}:{dateMinutes}                   </p>
                        <p className="pr-5"> Temp: {element.main.temp} {toggleMetric()}          </p>
                        <img src={`https://openweathermap.org/img/wn/${weatherIcon}@2x.png`} alt={element.weather[0].main} />
                        <br />
                        </div>
                         </div>
